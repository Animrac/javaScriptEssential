...
let dietaryServicesRole = "enrolledMember";
let dietaryServicesMessage;

switch (dietaryServicesRole) {
    case "employee":
        dietaryServicesMessage = "authorized to have access to Dietary Services.";
        break;
    case "enrolledMember":
        dietaryServicesMessage = "authorized to have access to Dietary Services and one-on-one interaction with a dietician.";
        break;
    case "subscriber":
        dietaryServicesMessage = "authorized to have partial access to facilitate Dietary Services only.";
        break;
    case "nonSubscriber":
        dietaryServicesMessage = "need to enroll or at least subscribe first to avail this facility.";
        break;
    default:
        dietaryServicesMessage = "unknown.";
}
console.log("Authentication Status:", dietaryServicesMessage);	